import { OrderCacheImpl, type IOrderMetadata } from "./OrderCacheImpl";
...
describe("OrderCache", () => {
  ...
  it("Initialises with a list of items", () => {
    cache.init([
      { id: "order1", price: 10, itemId: "1" } as IOrderMetadata,
      { id: "order2", price: 12, itemId: "2" } as IOrderMetadata,
      { id: "order3", price: 10, itemId: "1" } as IOrderMetadata,
      { id: "order4", price: 15, itemId: "1" } as IOrderMetadata,
      { id: "order5", price: 1, itemId: "2" } as IOrderMetadata,
      { id: "order6", price: 6, itemId: "2" } as IOrderMetadata,
      { id: "order7", price: 20, itemId: "1" } as IOrderMetadata,
      { id: "order8", price: 5, itemId: "2" } as IOrderMetadata,
    ]);
  ...
  it("Inserts an item into an existing cache of size 1 (larger)", () => {
    cache.init([{ id: "order1", price: 10, itemId: "1" } as IOrderMetadata]);
    cache.add({
      id: "order2",
      price: 12,
      itemId: "1",
  ...
  it("Inserts an item into an existing cache of size 1 (smaller)", () => {
    cache.init([{ id: "order1", price: 10, itemId: "1" } as IOrderMetadata]);
    cache.add({ id: "order2", price: 8, itemId: "1" } as IOrderMetadata);
  ...
  it("Inserts an item into a large cache", () => {
    cache.init([
      { id: "order1", price: 10, itemId: "1" } as IOrderMetadata,
      { id: "order2", price: 12, itemId: "1" } as IOrderMetadata,
      { id: "order3", price: 10, itemId: "1" } as IOrderMetadata,
      { id: "order4", price: 15, itemId: "1" } as IOrderMetadata,
      { id: "order5", price: 1, itemId: "1" } as IOrderMetadata,
      { id: "order6", price: 6, itemId: "1" } as IOrderMetadata,
      { id: "order7", price: 20, itemId: "1" } as IOrderMetadata,
      { id: "order8", price: 5, itemId: "1" } as IOrderMetadata,
    ]);

    cache.add({ id: "order9", price: 7, itemId: "1" } as IOrderMetadata);
  ...
  it("Removes a nonexistent item", () => {
    cache.remove({ id: "order1", itemId: "1" } as IOrderMetadata);
  ...
  it("Removes a real item from an existing large cache", () => {
    ...
    cache.remove({ id: "order6", itemId: "1" } as IOrderMetadata);
